...
class _SessionPageState extends State<SessionPage> {
  ...
  void initState() {
    super.initState();
    context.read<SessionCubit>().startSession(widget.topicId, widget.categoryId);
  }
          ...
          child: BlocBuilder<SessionCubit, SessionState>(
            builder: (context, state) {
              ...
              if (state is SessionError) {
                return Center(child: Text(state.message, style: AppTextStyles.body));
              }
              ...
              children: [
                ...
                ...question.options.asMap().entries.map((entry) {
                  ...
                  return OptionTile(
                    ...
                    onTap: state.isAnswerRevealed ? null : () => cubit.selectOption(idx),
                  );
                }),
                if (state.isAnswerRevealed) ...[
                  ...
                  const SizedBox(height: 16),
                  AppButton.primary(
                    state.isLastQuestion ? 'Ver resultados' : 'Siguiente pregunta',
  ...
  OptionState _getOptionState(int index, SessionInProgress state) {
    ...
    if (index == state.currentQuestion.correctOptionIndex) return OptionState.correct;
