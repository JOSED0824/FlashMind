                ...
                child: SafeArea(
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        Text(widget.categoryName, style: AppTextStyles.headline),
            ...
            builder: (context, state) {
              ...
              if (state is TopicSelectionError) {
                return SliverFillRemaining(
                  child: Center(child: Text(state.message, style: AppTextStyles.body)),
                );
              }
                  ...
                  sliver: SliverList(
                    delegate: SliverChildBuilderDelegate(
                      (context, index) => TopicCard(
                        ...
                        onTap: () => context.push(RouteNames.session, extra: {
